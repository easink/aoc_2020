defmodule AOCDay04Test do
  ...
  test "part 1, testset" do
    assert AOC.Day04.part1(@testset) == 2
  end

  test "part 1, input" do
    assert AOC.Day04.part1(@input) == 235
  end
  ...
  test "part 2, testset" do
    assert AOC.Day04.validate_byr(true, "2002") == true
    assert AOC.Day04.validate_byr(true, "2003") == false

    assert AOC.Day04.validate_hgt(true, "60in") == true
    assert AOC.Day04.validate_hgt(true, "190cm") == true
    assert AOC.Day04.validate_hgt(true, "190in") == false
    assert AOC.Day04.validate_hgt(true, "190") == false

    assert AOC.Day04.validate_hcl(true, "#123abc") == true
    assert AOC.Day04.validate_hcl(true, "#123abz") == false
    assert AOC.Day04.validate_hcl(true, "123abc") == false

    assert AOC.Day04.validate_ecl(true, "brn") == true
    assert AOC.Day04.validate_ecl(true, "wat") == false

    assert AOC.Day04.validate_pid(true, "000000001") == true
    assert AOC.Day04.validate_pid(true, "0123456789") == false

    assert AOC.Day04.part2(@invalids) == 0
    assert AOC.Day04.part2(@valids) == 4
  end

  test "part 2, input" do
    assert AOC.Day04.part2(@input) == 194
  end
end
