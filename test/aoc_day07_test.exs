defmodule AOCDay07Test do
  ...
  test "part 1, testset" do
    assert AOC.Day07.part1(@testset) |> length == 4
  end

  test "part 1, input" do
    assert AOC.Day07.part1(@input) |> length == 144
  end

  test "part 2, testset" do
    assert AOC.Day07.part2(@testset) == 32
  end

  test "part 2, testset2" do
    assert AOC.Day07.part2(@testset2) == 126
  end

  test "part 2, input" do
    assert AOC.Day07.part2(@input) == 5956
  end
end
