defmodule AOCDay18Test do
  ...
  test "part 1, testsets" do
    ...
    assert Day18.part1(@testset) == 51 + 26 + 437 + 12240 + 13632
  end

  test "part 1, input" do
    assert Day18.part1(@input) == 800_602_729_153
  end
  ...
  test "part 2, testset" do
    p = [{?+, 1}]
    assert Day18.eval('1+2*3+4*5+6', p) == 231
    assert Day18.eval('1+(2*3)+(4*(5+6))', p) == 51
    assert Day18.eval('2*3+(4*5)', p) == 46
    assert Day18.eval('5+(8*3+9+3*4*3)', p) == 1445
    assert Day18.eval('5*9*(7*3*3+9*3+(8+6*4))', p) == 669_060
    assert Day18.eval('((2+4*9)*(6+9*8+6)+6)+2+4*2', p) == 23340
    assert Day18.part2(@testset2) == 231 + 51 + 46 + 1445 + 669_060 + 23340
  end

  test "part 2, input" do
    assert Day18.part2(@input) == 92_173_009_047_076
  end
end
