defmodule AOCDay19Test do
  ...
  test "part 1, testsets" do
    ...
    assert Day19.pattern_match?(rules, 'ababbb')
    refute Day19.pattern_match?(rules, 'bababa')
    assert Day19.pattern_match?(rules, 'abbbab')

    refute Day19.pattern_match?(rules, 'aaabbb')
    refute Day19.pattern_match?(rules, 'aaaabbb')
    assert Day19.part1(@testset) == 2
  end

  test "part 1, input" do
    assert Day19.part1(@input) == 192
  end
  ...
  test "part 2, testset" do
    assert Day19.part1(@testset2) == 3
    assert Day19.part2(@testset2) == 12
  end

  test "part 2, input" do
    assert Day19.part2(@input) == 296
  end
end
