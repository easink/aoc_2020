defmodule AOCDay24Test do
  ...
  test "part 1, testset" do
    assert Day24.part1(@testset) == 10
  end

  test "part 1, input" do
    assert Day24.part1(@input) == 473
  end

  test "part 2, testset" do
    assert Day24.part2(@testset, 1) == 15
    assert Day24.part2(@testset, 2) == 12
    assert Day24.part2(@testset, 3) == 25
    assert Day24.part2(@testset, 4) == 14
    assert Day24.part2(@testset, 5) == 23
    assert Day24.part2(@testset, 6) == 28
    assert Day24.part2(@testset, 7) == 41
    assert Day24.part2(@testset, 8) == 37
    assert Day24.part2(@testset, 9) == 49
    assert Day24.part2(@testset, 10) == 37
    assert Day24.part2(@testset, 20) == 132
    assert Day24.part2(@testset, 30) == 259
    assert Day24.part2(@testset, 40) == 406
    assert Day24.part2(@testset, 50) == 566
    assert Day24.part2(@testset, 60) == 788
    assert Day24.part2(@testset, 70) == 1106
    assert Day24.part2(@testset, 80) == 1373
    assert Day24.part2(@testset, 90) == 1844
    assert Day24.part2(@testset, 100) == 2208
  end

  test "part 2, input" do
    assert Day24.part2(@input, 100) == 4070
  end
end
